...
const pt: Strings = {
  ...
  today: {
    ...
    onlySees: 'O Hipocampo só enxerga a partir do dia em que começou a medir.',
...
const en: Strings = {
  ...
  today: {
    ...
    onlySees: 'Hipocampo only sees from the day it started measuring.',
...
const es: Strings = {
  ...
  today: {
    ...
    onlySees: 'Hipocampo solo ve desde el día en que empezó a medir.',
...
const fr: Strings = {
  ...
  today: {
    ...
    onlySees: 'Hipocampo ne voit qu’à partir du jour où il a commencé à mesurer.',
...
const de: Strings = {
  ...
  today: {
    ...
    onlySees: 'Hipocampo sieht erst ab dem Tag, an dem es zu messen begann.',
